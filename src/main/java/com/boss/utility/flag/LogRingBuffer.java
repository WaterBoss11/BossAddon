    ...
    public static synchronized void install() {
        ...
        try {
            ...
            AbstractAppender appender =
                new AbstractAppender("BossUtilityFlagRing", null, null, true, Property.EMPTY_ARRAY) {
            ...
            ctx.updateLoggers();
            installed = true;
            System.out.println("[boss-utility/flags] log ring buffer installed on root logger");
        } catch (Throwable t) {
            System.out.println("[boss-utility/flags] log ring buffer install failed: " + t);
        }
    }
