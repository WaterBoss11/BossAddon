...
public final class BedAuraModule extends Module {
    ...
    public BedAuraModule() {
        super(BossPvpAddon.ID + ":bedaura", "BedAura", "Places and detonates exploding beds on enemies.");
        ...
        add(new IntSetting("delay", "Action delay (ms)", 150, 0, 1000, 10).visibleWhen(MenuMode::advanced).group("Actions"));
        ...
        add(new DoubleSetting("legitEase", "Camera turn speed", 0.25, 0.05, 1.0, 0.05)
            .description("How fast your camera turns to the place/detonate spot in Real rotation mode (higher = snappier).").visibleWhen(MenuMode::advanced).group("Targeting"));
